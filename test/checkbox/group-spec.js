...
describe('Checkbox.Group', () => {
    ...
    describe('[focus] call focus()', () => {
        ...
        it('should focus the first enable checkbox', () => {
            wrapper = mount(
                <CheckboxGroup defaultValue={['apple']}>
                    <Checkbox disabled value="2-1">
                        1
                    </Checkbox>
        ...
        it('should focus in datasource mode', () => {
            wrapper = mount(<CheckboxGroup defaultValue={['apple']} dataSource={list} />, {
                attachTo: target,
            });
            const group = wrapper.instance().getInstance();
            group.focus();
